...
- Tests: engine 9 + integration 39 (incl. `test_batch_cancelledOrders_doNotMoveClearingPrice` + `test_batch_residualSpotSwap_inheritsSandwichHonestLimit`) + fork 3 + fuzz 5 invariants = **56**. foundry.toml `optimizer_runs = 20000`.
