...
| TSK-07 | Deploy to Sepolia/Lasna + `depositTo` funding | ✅ Deployed + funded 2026-08-18; all 7 Sepolia contracts Etherscan-verified (todo 2.4 ✅). Lasna Sourcify still blocked by endpoint outage (todo 3.2 half-done: funding fixed, browser Active-status check pending) |
